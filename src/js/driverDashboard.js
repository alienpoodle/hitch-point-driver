...
import {
    doc, getDoc, setDoc, updateDoc, collection, query, where, onSnapshot, orderBy, limit
    ...
    if (activeRide && currentRideDisplay) {
        ...
        currentRideDisplay.innerHTML = `
            <div class="card-body">
                ...
                ${pickupPointsHtml} <p class="card-text"><strong>Final Destination:</strong> ${activeRide.destination}</p>
...
function renderPendingRequests(requests) {
    ...
    requests.forEach(request => {
        ...
        row.innerHTML = `
            ...
            <td data-label="Pickup Points">${pickupPointsDisplay}</td> <td data-label="Final Destination">${request.destination}</td>
...
function renderRideHistory(history) {
    ...
    history.forEach(ride => {
        ...
        row.innerHTML = `
            ...
            <td data-label="Pickup Points">${pickupPointsDisplay}</td> <td data-label="Final Destination">${ride.destination}</td>
